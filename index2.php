    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') { ?>
        ...
        <html>
          <head>
			...
			<meta name="description" conent="Encuentra a la Comparsa de Gigantes y Cabezudos de Pamplona en sus recorrido en San Fermin. En directo">
            ...
            <script src="script.js?version=22"></script> 			    
              ...
              <div class="hero-body p-4">
				<div>
					<span class="is-pulled-right">
						<a class="has-text-white" onclick="changeLan('cas')"> CAS </a>
						<a class="has-text-white ml-3" onclick="changeLan('eus')"> EUS </a>
						<a class="has-text-white ml-3" onclick="changeLan('eng')"> ENG </a>
					</span>
				</div>
				<br>
                <div class="columns">
